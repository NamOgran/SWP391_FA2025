        ...
        <style>
            ...
            *{
            ...
            .dropdownMenu{
                ...
                top:100%;
                left:0;
                width:200px; /* đúng kích thước như History */
                background:#fff;
            ...
            /* KHỬ tràn do .row ở ngoài .container */
                                                        ...
                                                        <div class="col-12 col-md-4">
                                                            <div id="price">
                                                                <div class="row">
                                                                    ...
                                                                    <p class="col-6 origin-price"><fmt:formatNumber value="${lineOrig}" pattern="###,###"/> VND</p>
                                                                    <p class="col-6 saled-price"><fmt:formatNumber value="${lineDisc}" pattern="###,###"/> VND</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="info">
                                            <div id="product-bottom" class="row align-items-center">
                                                ...
                                                <div class="col-12 col-md-2">
                                                    <c:set var="formattedTotal"><fmt:formatNumber value="${o.total}" pattern="###,###"/></c:set>
