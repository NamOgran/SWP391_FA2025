<%-- 
    ...
    Description: Product Management (Full Updated: Input Discount 0-100%)
--%>
...
<html lang="en">
    ...
    <body id="admin-body">
                                            ...
                                            <tr class="${p.is_active ? '' : 'row-inactive'}">
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <c:if test="${discount > 0}">
                                                        <span class="badge bg-danger rounded-pill mb-1" style="font-size: 0.75rem;">-${discount}%</span><br>
                                                    </c:if>
                                                    ...
                                                    <div class="d-flex flex-column align-items-center gap-2">
                                                        ...
                                                        <div class="d-flex gap-2">
                                                            <button type="button" class="btn-soft btn-soft-primary" data-bs-toggle="modal" data-bs-target="#updateProductModal"
                                                                    ...
                                                                    data-voucher-percent="${p.discount}" 
                                                                    title="Edit">
                                                        ...
                                                        <div class="d-flex gap-2">
                                                            ...
                                                            <button type="button" class="btn-soft btn-soft-info" data-bs-toggle="modal" data-bs-target="#viewProductModal"
                                                                    ...
                                                                    data-price="${p.price}" data-voucher="${p.discount}"
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-8">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <%-- [UPDATED] Input for Discount --%>
                                                <input type="number" name="voucher" class="form-control" placeholder="Discount (%)" value="0" min="0" max="100" required>
                                ...
                                <div class="col-md-8">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <%-- [UPDATED] Input for Discount --%>
                                                <input type="number" name="voucher" id="update_voucher" class="form-control" placeholder="Discount (%)" min="0" max="100" required>
                                                <label>Discount (%)</label>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
        ...
        <script>
                                            ...
                                            // --- SPA LOGIC WITH LOADER & BLUR ---

                                            // Toggle table blur effect
                                            function toggleTableBlur(active) {
                                                if (active)
                                                    $('#productTableMain tbody').addClass('table-blur');
                                                else
                                                    $('#productTableMain tbody').removeClass('table-blur');
                                            }
                                            ...
                                            $("#addForm").validate({
                                                rules: {
                                                    ...
                                                    pic: {required: function (element) {
                                                            return $('#add_file_input')[0].files.length === 0;
                                                        }},
                                                    // [UPDATED] Validate Voucher/Discount Input
                                                    voucher: {required: true, number: true, min: 0, max: 100}
                                                },
                                                messages: {
                                                    price: {max: "Max Price is 999.999.999"},
                                                    voucher: {min: "Min 0%", max: "Max 100%"}
                                                },
                                                errorElement: "label", errorClass: "error", errorPlacement: function (error, element) {
                                            ...
                                            $("#updateForm").validate({
                                                rules: {
                                                    ...
                                                    des: {required: true, maxlength: 255},
                                                    pic: {required: function (element) {
                                                            return $('#update_file_input')[0].files.length === 0;
                                                        }},
                                                    // [UPDATED] Validate Voucher/Discount Input
                                                    voucher: {required: true, number: true, min: 0, max: 100}
                                                },
                                            ...
                                            $('#confirmToggleButton').click(function () {
                                                ...
                                                $.ajax({
                                                    url: '${BASE_URL}/admin', // Correct URL
                                                    type: 'POST', // Change to POST to match handleProductAction
                                                    data: {
                                                    ...
                                                    success: function (data) {
                                                        ...
                                                        if (data.isSuccess) {
                                                            ...
                                                            loadTable(getFilterUrl()); // Reload the table
                                                        } else {
                                                            alert(data.description || 'Error changing status');
                                                        }
                                                        // Re-enable button
                                            ...
                                            if (viewModalEl) {
                                                viewModalEl.addEventListener('show.bs.modal', function (event) {
                                                    ...
                                                    // Logic updated: voucher attribute now contains int discount
                                                    const discountVal = parseInt(voucher);
                                                    document.getElementById('view_voucher').textContent = (discountVal > 0) ? '-' + discountVal + '%' : '';
                                            ...
                                            if (updateModalEl) {
                                                updateModalEl.addEventListener('show.bs.modal', function (event) {
                                                    ...
                                                    // [UPDATED] Populate Discount Input
                                            ...
                                            if (deleteModalEl) {
                                                deleteModalEl.addEventListener('show.bs.modal', function (event) {
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        type: 'GET',
                                                        data: {
                                                            action: 'get_product_related_data',
                                                            productId: productId
                                                        },
                                                        dataType: 'json',
                                                        success: function (data) {
                                                            ...
                                                            if (data.carts && data.carts.length > 0) {
                                                                ...
                                                                $.each(data.carts, function (i, item) {
                                                                    $('#carts-table-body').append('<tr><td>' + item.cart_id + '</td><td>' + item.customer_id + '</td><td>' + item.size_name + '</td><td>' + item.quantity + '</td></tr>');
                                                                });
                                                            ...
                                                            if (data.imports && data.imports.length > 0) {
                                                                ...
                                                                $.each(data.imports, function (i, item) {
                                                                    $('#imports-table-body').append('<tr><td>' + item.id + '</td><td>' + item.date + '</td><td>' + item.total + '</td><td>' + item.status + '</td></tr>');
                                                                });
                                                            ...
                                                            if (data.feedbacks && data.feedbacks.length > 0) {
                                                                ...
                                                                $.each(data.feedbacks, function (i, item) {
                                                                    $('#feedbacks-table-body').append('<tr><td>' + item.feedback_id + '</td><td>' + item.customer_id + '</td><td>' + item.rate_point + '</td></tr>');
                                                                });
