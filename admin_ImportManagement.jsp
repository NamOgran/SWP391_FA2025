...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .table-modern tr.selected-row td {
                background-color: #eef2ff !important;
                border-top: 2px solid #4e73df;
                border-bottom: none;
            }
            .table-modern tr.selected-row td:first-child {
                border-left: 2px solid #4e73df;
            }
            .table-modern tr.selected-row td:last-child {
    ...
    <body id="admin-body">
        ...
        <script>
                        ...
                        function renderPage(page) {
                            ...
                            allRowsData.forEach(item => {
                                ...
                                if (btn) {
                                    ...
                                    $(btn).find('i').attr('class', 'bi bi-chevron-down');
                                }
                            });
                            ...
                            pageItems.forEach(item => {
                                item.el.style.display = 'table-row';
                            });
                        ...
                        function submitImport() {
                            if (importItems.length === 0) {
                                showToast("Import list is empty!", "error");
                                return;
                            }
                        ...
                        function confirmImport(id) {
                            if (!confirm("Confirm import? Stock will be updated immediately."))
                                return;
                            toggleTableBlur(true);
                        ...
                        function cancelImport(id) {
                            if (!confirm("Are you sure you want to CANCEL this import order? This action cannot be undone."))
                                return;
