...
public class StatsDAO extends DBConnect {
    ...
    public static class OrderPopupData {
        ...
        public OrderPopupData() { this.details = new ArrayList<>(); }
        ...
        public List<OrderDetailData> getDetails() { return details; }
        public void setDetails(List<OrderDetailData> details) { this.details = details; }
    }
    ...
    public Map<String, Integer> getOrderStatusCounts(Date from, Date to) {
        ...
        try (Connection conn = new DBConnect().getConnection();
            ...
            while (rs.next()) {
                ...
                if (status != null) map.put(status, rs.getInt("cnt"));
            }
        } catch (Exception e) { e.printStackTrace(); }
        return map;
    }
