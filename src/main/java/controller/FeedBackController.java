...
/**
 * Controller xử lý tất cả các tác vụ liên quan đến Feedback - GET: Xem lịch sử
 * đánh giá - POST: Gửi đánh giá mới
 */
...
public class FeedBackController extends HttpServlet {
    ...
    /**
     * Xử lý GET: Hiển thị trang lịch sử đánh giá (Logic từ MyFeedbackController
     * cũ)
     */
    @Override
    ...
    /**
     * Xử lý POST: Nhận JSON để tạo đánh giá mới (Logic từ FeedBackController
     * cũ)
     */
    @Override
