    ...
    <body id="admin-body">
        ...
        <script>
                                                    ...
                                                    function toggleTableBlur(active) {
                                                        if (active)
                                                            $('#customer-table tbody').addClass('table-blur');
                                                        else
                                                            $('#customer-table tbody').removeClass('table-blur');
                                                    }
                                                    ...
                                                    function renderPage(page) {
                                                        ...
                                                        pageItems.forEach(r => {
                                                            r.summary.style.display = 'table-row';
                                                        });
                                                        ...
                                                        if (total > 1) {
                                                            if (page > 1)
                                                                html += `<li class="custom-page-item"><a class="custom-page-link" href="#" onclick="changePage(event, \${page-1})"><i class="bi bi-chevron-left"></i></a></li>`;
                                                            ...
                                                            if (page < total)
                                                                html += `<li class="custom-page-item"><a class="custom-page-link" href="#" onclick="changePage(event, \${page+1})"><i class="bi bi-chevron-right"></i></a></li>`;
                                                        }
                                                        html += '</ul>';
                                                        if (filteredRows.length === 0)
                                                            html = '<div class="text-center text-muted py-3 w-100">No customers found.</div>';
