...
<head>
    ...
    <style>
        ...
        /* --- LAYOUT --- */
        .login-wrapper { height: 100vh; width: 100%; }
        ...
        .brand-caption {
            position: absolute; bottom: 50px; left: 50px; color: #fff; z-index: 2;
        }
        .brand-caption h1 { font-weight: 700; letter-spacing: 2px; margin-bottom: 10px; }
        .brand-caption p { font-size: 1.1rem; opacity: 0.9; font-weight: 300; }
        ...
        /* --- FORM ELEMENTS --- */
        .page-title { font-size: 2rem; font-weight: 700; color: var(--text-dark); margin-bottom: 10px; }
        .page-subtitle { color: var(--text-muted); margin-bottom: 40px; font-size: 0.75rem }
        ...
        .btn-google:hover { background-color: #f8f9fa; border-color: #ccc; }
        .btn-google img { width: 22px; margin-right: 10px; }

        .divider { display: flex; align-items: center; color: #999; margin: 20px 0; font-size: 0.85rem; text-transform: uppercase; }
        .divider::before, .divider::after { content: ''; flex: 1; border-bottom: 1px solid #eee; }
        .divider span { padding: 0 15px; }

        .form-links { display: flex; justify-content: space-between; align-items: center; font-size: 0.9rem; margin-bottom: 20px; }
        .form-links a { color: var(--text-muted); text-decoration: none; transition: 0.2s; }
        .form-links a:hover { color: var(--primary-color); }
        ...
        /* Error Alert In Form */
        .alert-custom-danger { background-color: #fff2f2; color: #842029; border: 1px solid #ffcccc; border-radius: 8px; font-size: 0.95rem; margin-bottom: 20px; }
        ...
        .toast-alert {
            ...
            animation: slideInRight 0.5s cubic-bezier(0.68, -0.55, 0.27, 1.55) forwards; border-left: 5px solid; max-width: 350px;
        }
        @keyframes slideInRight { from { transform: translateX(120%); opacity: 0; } to { transform: translateX(0); opacity: 1; } }
        @keyframes slideOutRight { from { opacity: 1; transform: translateX(0); } to { opacity: 0; transform: translateX(120%); } }
        .toast-alert.hide-toast { animation: slideOutRight 0.5s ease-in forwards; }
        .toast-alert.success { border-color: #28a745; } .toast-alert.success i { color: #28a745; font-size: 1.5rem; }
        .toast-alert.info { border-color: #17a2b8; } .toast-alert.info i { color: #17a2b8; font-size: 1.5rem; }
        .toast-message { font-weight: 600; color: #333; font-size: 15px; }
        .toast-close { margin-left: auto; cursor: pointer; color: #999; }
        .toast-close:hover { color: #333; }

        /* Responsive */
        @media (max-width: 992px) {
            .login-image-side { display: none; }
            .login-form-side { justify-content: center; }
            .btn-back-home { top: 20px; left: 20px; }
        }
    </style>
</head>
<body>
