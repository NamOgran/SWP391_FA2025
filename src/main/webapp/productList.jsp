<%--
    ...
    Updated     : Logic hiển thị giá & ảnh đồng bộ với Database mới (Int Discount)
--%>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <c:forEach items="${requestScope.productList}" var="product">
                            ...
                            <%-- [UPDATED] Lấy giá trị Discount trực tiếp từ Product --%>
                            <c:set var="discountPercent" value="${product.discount}" />

                            <%-- Fallback nếu getter trả về null (dành cho trường hợp Entity chưa update getter int) --%>
