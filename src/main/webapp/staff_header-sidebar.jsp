...
<style>
    * {
    ...
    .staff-name:hover .staff-dropdown {
        display: block;
    }
    ...
    .staff-dropdown li a:hover {
        background-color: #f8f9fa;
        color: var(--header-bg);
        padding-left: 25px;
    }
    .staff-dropdown li a i {
        width: 20px;
        text-align: center;
    }
    ...
    body.collapsed .nav-list li a span {
        opacity: 0;
        visibility: hidden;
        width: 0;
        display: inline-block;
    }
    body.collapsed .nav-list li a {
        justify-content: center;
        padding: 15px 0;
    }
    body.collapsed .nav-list li a i {
        margin: 0;
        font-size: 1.3em;
    }
