<%-- 
    ...
    Description: Staff/Admin Personal Info & Change Password (Fixed Validation UI)
--%>
...
<head> 
    ...
    <style>
        ...
        /* Fix z-index for form-floating to show red border correctly */
...
<body id="admin-body">
    ...
    <script>
        ...
        // Cấu hình chung cho Validation (Fix lỗi mất chữ trong form-floating)
        const validationConfig = {
            errorElement: "label",
            errorClass: "error",
            errorPlacement: function (error, element) {
                // Nếu input nằm trong form-floating, đặt lỗi ra ngoài div bao quanh
        ...
        $(document).ready(function () {
            ...
            $("#editProfileForm").validate({
                ...validationConfig, // Kế thừa cấu hình
                rules: {
