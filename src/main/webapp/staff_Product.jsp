<%-- 
    ...
    Description: Product Management for Staff (Read-Only Mode) - Updated for Discount Int
--%>
    ...
    <head> 
        ...
        <style>
            ...
            .custom-page-item.active .custom-page-link {
                ...
                box-shadow: 0 3px 8px rgba(121, 85, 72, 0.3);
            }
                                    ...
                                    <c:when test="${not empty list}">
                                        <c:forEach var="p" items="${list}">
                                            <tr class="${p.is_active ? '' : 'row-inactive'}">
                                                ...
                                                <td class="text-end">
                                                    <%-- [UPDATED] Use p.discount instead of map --%>
                                                    <c:if test="${p.discount > 0}">
                                                        <span class="badge bg-danger rounded-pill mb-1" style="font-size: 0.75rem;">-${p.discount}%</span><br>
                                                    </c:if>
        ...
        <script>
                                 ...
                                 if (viewModalEl) {
                                     viewModalEl.addEventListener('show.bs.modal', function (event) {
                                         ...
                                         // [UPDATED] Read discount int
                                         const discount = btn.getAttribute('data-discount');
                                         const badge = document.getElementById('view_voucher');
