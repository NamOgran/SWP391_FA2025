<%-- 
    Document    : signup.jsp
    Updated     : Layout Rearranged & Added Validation
--%>
...
<head>
    ...
    <style>
        ...
        .signup-container { width: 100%; max-width: 650px; padding: 20px 40px; }
        ...
        .form-floating label i { margin-right: 5px; color: var(--primary-color); }
...
.form-floating label.error {
    ...
    line-height: 1.2;          /* Giãn dòng một chút cho dễ đọc nếu tin nhắn dài */
        ...
        .toast-alert.danger { border-color: #dc3545; } .toast-alert.danger i { color: #dc3545; font-size: 1.5rem; }
        ...
        @media (max-width: 992px) {
            ...
            .signup-form-side { justify-content: center; height: 100vh; }
            .signup-container { padding: 80px 20px 40px 20px; }
