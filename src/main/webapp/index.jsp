...
<head>
    ...
    <style>
        ...
        .features-area {
            ...
            border-radius: var(--card-radius); margin-bottom: 60px;
        }
        .feature-item { text-align: center; padding: 20px; transition: var(--transition-smooth); }
        .feature-item:hover { transform: translateY(-5px); }
        .feature-icon { font-size: 2.5rem; color: var(--primary-color); margin-bottom: 15px; display: inline-block; }
        .feature-title { font-weight: 700; margin-bottom: 5px; color: var(--secondary-color); }
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="6000">
                        ...
                        <div class="hero-caption">
                            ...
                            <a href="#categories" class="btn-hero" data-aos="fade-up" data-aos-delay="800">Let's Shop</a>
                        </div>
                    </div>
