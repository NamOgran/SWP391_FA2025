    ...
    <body id="admin-body">
        ...
        <script>
                                                    ...
                                                    function toggleTableBlur(active) {
                                                        if (active)
                                                            $('#orderTableMain tbody').addClass('table-blur');
                                                        else
                                                            $('#orderTableMain tbody').removeClass('table-blur');
                                                    }
                                                    ...
                                                    function updateStatus(id, status) {
                                                        if (!confirm('Are you sure you want to update order #' + id + ' to ' + status + '?'))
                                                            return;
                                                        toggleTableBlur(true);
