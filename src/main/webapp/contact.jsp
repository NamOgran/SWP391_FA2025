...
<head>
    ...
    <style>
        ...
        .hero-title {
            font-size: 3rem; font-weight: 700; letter-spacing: 1px; margin-bottom: 10px;
        }
        .hero-subtitle {
        ...
        .info-content h5 {
            font-size: 1.1rem; font-weight: 700; color: var(--secondary-color); margin-bottom: 5px;
        }
        .info-content p {
        ...
        .section-title {
            font-size: 1.8rem; font-weight: 700; color: var(--secondary-color); margin-bottom: 10px;
        }
        .section-desc {
        ...
        @media (max-width: 768px) {
            ...
            .form-card, .info-card { padding: 25px; }
        }
    </style>
</head>
