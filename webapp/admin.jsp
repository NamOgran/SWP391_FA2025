    ...
    <body>
        <header>
            <div class="header-top">
                ...
                <a href="${pageContext.request.contextPath}/admin">Click to load Admin</a>
        ...
        <div class="main">
            ...
            <div class="main-content">
                ...
                <div class="product-manage">
                    ...
                    <!-- ✅ Bộ lọc & tìm kiếm -->
                    <div class="filter">
                        <form action="${pageContext.request.contextPath}/admin" method="get" style="display:flex;gap:10px;align-items:center;">
                            <select name="sort" id="filter-price">
                            ...
                            <input type="text" name="search" placeholder="Search product name" value="${param.search}" id="searchInput">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <c:forEach var="p" items="${list}">
                                    <tr>
                                        <td><img src="${p.picURL}" style="width:100px;height:100px;object-fit:contain;border-radius:8px;"></td>
                                        <td>${p.name}</td>
                                        ...
                                        <td>${p.description}</td>
                                        <td>
                                            <a href="${pageContext.request.contextPath}/updateJSPProduct?id=${p.id}" class="btn btn-primary">Update</a>
                                            <a href="${pageContext.request.contextPath}/deleteProduct?id=${p.id}" class="btn btn-danger"
