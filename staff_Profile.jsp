    ...
    <body id="staff-body">
        ...
        <div class="main-content p-4">
            <div class="d-flex align-items-center mb-4">
                <div class="text-white rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 50px; height: 50px; font-size: 1.5rem; background-color: var(--primary-color);">
            ...
            <div class="personal-main">
                <table class="table-borderless">
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge px-3 py-2 text-uppercase" style="background-color: var(--primary-color);">
            ...
            $(document).ready(function () {
                ...
                $("#editProfileForm").validate({
                    ...
                    submitHandler: function (form) {
                        handleFormSubmit(form, '${BASE_URL}/staff/profile/update');
                    }
                });
                ...
                $("#changePasswordForm").validate({
                    ...
                    submitHandler: function (form) {
                        handleFormSubmit(form, '${BASE_URL}/staff/profile/changepass', '#changePasswordModal');
                    }
                });
